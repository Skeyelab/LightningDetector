...
async function startFlashing() {
  ...
  try {
    ...
    updateStatus('Connected to ESP32. Starting flash process...', 'info');

    // Initialize ESPLoader with the port
    await flasher.connect(port);

    updateProgress(40, 'ESP32 identified');
    updateStatus('ESP32 identified. Flashing firmware...', 'info');
    ...
    updateStatus('Firmware flashed successfully!', 'success');
